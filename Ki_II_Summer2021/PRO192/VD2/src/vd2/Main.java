/*
Một thư viện cần quản lý các tài liệu bao gồm Sách, Tạp chí, Báo. Mỗi tài liệu gồm có các thuộc tính 
sau: Mã tài liệu(Mã tài liệu là duy nhất), Tên nhà xuất bản, số bản phát hành.
...
public class Main {
    ...
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
            ...
            double releaseNumber = scanner.nextInt();
            ...
            double numberPages = scanner.nextInt();
            
            Officer book = new Book(author, numberPages, documentCode, publishName, releaseNumber);
